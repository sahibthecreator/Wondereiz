...
const DropDown = ({
  ...
  const configSelectedBgStyle: StyleProp<ViewStyle> =
    getSelectedBgStyle(config);
  const configSelectedTextStyle: StyleProp<TextStyle> =
    getSelectedTextStyle(config);
  ...
  const NoDataComponent = noDataComponent
    ? noDataComponent
    : () => (
        <DefaultNoDataComponent text={noDataText} textStyle={configTextStyle} />
      );
        ...
        <View style={styles.searchContainer}>
          <TextInput
            ...
            placeholderTextColor={
              config?.placeholderTextColor ?? defaultPlaceholderColor
            }
          />
        </View>
      )}
